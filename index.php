			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-body">
						...
						<p>
							Here, I have implemented a generic directed, weighted graph data structure to traverse. To use this algorithm for pathfinding, the world space should be represented as this type of graph.
						...
						<p>
							In the examples below, the start node is marked green, the goal node is marked red, and the shortest path as found by the algorithm is coloured blue.
						</p>
